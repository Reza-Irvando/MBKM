...
def TemplateCreate():
    try:
        ...
        collTemplate = models.Templates(
            ...
            templateCode=bodyJson["templateCode"], 
        ...
        return responses.Make(
            ...
            Data={
                ...
                "templateCode": collTemplate.templateCode,
...
def TemplateUpdate():
    try:
        ...
        collTemplate.update(templateName=bodyJson["templateName"], templateCode=bodyJson["templateCode"], templateContent=bodyJson["templateContent"], templateLength=bodyJson["templateLength"], categoryId=ObjectId(bodyJson["categoryId"]), updatedBy=ObjectId(userId))
        return responses.Make(
