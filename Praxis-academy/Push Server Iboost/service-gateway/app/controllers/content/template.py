...
def TemplateList():
    try:
        ...
        ### start hit service ###
        path = f"{serviceContent}/content/template/list"
...
def TemplateCreate():
    try:
        ...
        path = f"{serviceContent}/content/template/create?userId={accessData['data']['userId']}"
...
def TemplateDetail():
    try:
        ...
        path = f"{serviceContent}/content/template/detail?templateId={templateId}"
        responseAPI = httpx.get(path)
        responseJson = responseAPI.json()
        return responses.Make(Status=responseJson["status"], Message=responseJson["message"], Data=responseJson["data"]), 200
        ### stop hit service ###
...
def TemplateUpdate():
    try:
        ...
        bodyJson = request.json
        templateId = request.args["templateId"]
        path = f"{serviceContent}/content/template/update?userId={accessData['data']['userId']}&templateId={templateId}"
...
def TemplateDelete():
    try:
        ...
        ### start hit service ###
        templateId = request.args["templateId"]
        path = f"{serviceContent}/content/template/delete?userId={accessData['data']['userId']}&templateId={templateId}"
