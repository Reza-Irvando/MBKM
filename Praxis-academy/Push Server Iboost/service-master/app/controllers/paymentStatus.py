...
def PaymentStatusCreate():
    try:
        ...
        collPaymentStatus = models.PaymentStatus(
            paymentStatusName=bodyJson["paymentStatusName"], paymentStatusCode=bodyJson["paymentStatusCode"], updatedBy=ObjectId(userId), createdBy=ObjectId(userId))
        ...
        return responses.Make(
            ...
            Data={
                ...
                "paymentStatusCode": collPaymentStatus.paymentStatusCode
            }
        ), 200
    except Exception as err:
        error(err)
...
def PaymentStatusUpdate():
    try:
        ...
        collPaymentStatus.update(paymentStatusName=bodyJson["paymentStatusName"], paymentStatusCode=bodyJson["paymentStatusCode"], updatedBy=ObjectId(userId))
        return responses.Make(
