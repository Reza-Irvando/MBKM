...
def CategoryCreate():
    try:
        ...
        collCategory = models.Categories(
            categoryName=bodyJson["categoryName"], categoryCode=bodyJson["categoryCode"], updatedBy=ObjectId(userId), createdBy=ObjectId(userId))
        collCategory.save()
        return responses.Make(
            Status=200,
            Message="success",
            Data={
                ...
                "categoryCode": collCategory.categoryCode
            }
        ), 200
    except Exception as err:
        error(err)
...
def CategoryUpdate():
    try:
        ...
        collCategory.update(categoryName=bodyJson["categoryName"], categoryCode=bodyJson["categoryCode"], updatedBy=ObjectId(userId))
        return responses.Make(
