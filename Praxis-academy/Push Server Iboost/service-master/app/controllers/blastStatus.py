    ...
    try:
        ...
        for d in collBlastStatus:
            dataArray.append({
                ...
                "blastStatusCode": d.blastStatusCode
            })
...
def BlastStatusCreate():
    try:
        ...
        collBlastStatus = models.BlastStatus(
            blastStatusName=bodyJson["blastStatusName"], blastStatusCode=bodyJson["blastStatusCode"], updatedBy=ObjectId(userId), createdBy=ObjectId(userId))
        ...
        return responses.Make(
            ...
            Data={
                ...
                "blastStatusCode": collBlastStatus.blastStatusCode
            }
        ), 200
    except Exception as err:
        error(err)
